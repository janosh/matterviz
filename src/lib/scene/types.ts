...
// Camera/lighting/interaction props shared by all Threlte scene components
// (BrillouinZoneScene, FermiSurfaceScene, StructureScene, ...)
export type SceneControlProps = {
  ...
  auto_rotate?: number // auto-rotation speed. 0 disables auto-rotation
