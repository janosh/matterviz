...
// A tag opens with a letter, `/` or `!`. Matching bare `<[^>]*>` instead ate prose between a
// comparison pair: `T < 300 K and P > 1 bar` read back as `T  1 bar` in search and aria-labels.
