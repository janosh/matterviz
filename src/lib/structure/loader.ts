...
export function open_structure_text(
  ...
  // Layers index the volumes they were made for, so they go with them when a different cell
  // drops the loaded volumes; that also keeps "layers without volumes" meaning caller-supplied
