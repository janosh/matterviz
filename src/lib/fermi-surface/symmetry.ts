...
// hexagonal a = 3.21, c = 5.21 cell rounded to 4 decimals deviates by 7.2e-6, losing 24 ops
// down to 8 and tiling only a third of the zone with no visible symptom.
