...
// Composition offsets (atomic fraction) probed outside a tie-line end to identify the
// adjacent single-phase field. Widening steps cover narrow terminal solid solutions.
