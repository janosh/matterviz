...
import type { DenseInternalPoint } from '$lib/plot/adaptive-density'
import type ColorBar from '$lib/plot/ColorBar.svelte'
import type { LabelPlacementConfig, ScaleType, ScatterHandlerProps } from '$lib/plot/types'
