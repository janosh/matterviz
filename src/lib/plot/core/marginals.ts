...
function compute_histogram(
  ...
  // d3's nice thresholds rather than the requested count (50 for a requested 60). Sharing the
  // Histogram's binner also keeps a marginal strip agreeing bar for bar with the full chart.
