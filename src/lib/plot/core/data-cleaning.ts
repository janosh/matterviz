...
function apply_smoothing(
  ...
  // Nadaraya-Watson, not the DOS convolution: outlier removal leaves an irregular x grid,
  // where a measure-weighted convolution droops at the series ends. NW is exact on constants.
