...
>
  ...
  // The band the tiling reserved above a branch's children, which labels fit and clip to
  ...
  // Probes the settled tiling, like legend_points: reading the tweened rects re-ran this
  // ~24 times per zoom and flickered the icons through every cell sweeping the corner.
