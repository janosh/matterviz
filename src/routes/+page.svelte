<script lang="ts">
  ...
  import StructureFileViewer from '$lib/structure/StructureFileViewer.svelte'
...
<p>
  The 3d structure viewer is built on the declarative <a href="https://threejs.org">three.js</a
  >
...
<p>
  Compare phonon dispersions from DFT (PBE) against the M3GNet, CHGNet and MACE
  machine-learning interatomic potentials, with a synced 3d Brillouin zone, band structure and
...
<p>
  ...
  (triangle) alongside the full quaternary (tetrahedron): orbit the phase simplex, hover
  entries for formation energy and energy above hull, and toggle stable/unstable phases. Pick a
