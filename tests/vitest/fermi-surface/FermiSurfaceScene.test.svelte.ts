...
// lattice_point_group_matrices memoized into a module-level SvelteMap inside the
// `symmetry_ops` $derived, which Svelte 5 rejects with state_unsafe_mutation. Must stay the
// only tiled mount in this file: a populated cache hides the bug.
