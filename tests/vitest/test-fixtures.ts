...
export const simple_structure: AnyStructure = {
  id: `test_h2o`,
  ...make_crystal(10, [
    { element: `H`, xyz: [0.757, 0.586, 0], label: `H`, oxidation_state: 1 },
    { element: `O`, xyz: [0, 0, 0], label: `O`, oxidation_state: -2 },
    { element: `H`, xyz: [-0.757, 0.586, 0], label: `H`, oxidation_state: 1 },
  ]),
}
...
export const complex_structure: AnyStructure = {
  id: `test_complex`,
  ...make_crystal(5, [
    { element: `Li`, xyz: [0, 0, 0], label: `Li`, oxidation_state: 1 },
    { element: `Fe`, xyz: [2.5, 0, 0], label: `Fe`, oxidation_state: 2 },
    { element: `P`, xyz: [0, 2.5, 0], label: `P`, oxidation_state: 5 },
    { element: `O`, xyz: [1.25, 1.25, 0], label: `O`, oxidation_state: -2 },
    { element: `O`, xyz: [3.75, 1.25, 0], label: `O`, oxidation_state: -2 },
    { element: `O`, xyz: [1.25, 3.75, 0], label: `O`, oxidation_state: -2 },
    { element: `O`, xyz: [3.75, 3.75, 0], label: `O`, oxidation_state: -2 },
  ]),
}
