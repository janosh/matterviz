...
describe(`fit_eos`, () => {
  ...
  // Cu-like 9-point scan at ~20 meV used to return V0 = 9.82, B0' = 42.7 against a truth of
  // 40 / 4.5, silently; Vinet still lands at V0 = 11.05 and must be rejected, not reported.
