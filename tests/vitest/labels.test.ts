...
describe(`format_bytes`, () => {
  test.each([
    ...
    // Kilobytes range (1024 - 1024*1024)
    [1024, `1.00 KB`],
    [1536, `1.50 KB`],
    [10240, `10.00 KB`],
    [102400, `100.00 KB`],
    ...
    // Megabytes range (1024*1024 - 1024*1024*1024)
    [1024 * 1024, `1.00 MB`],
    ...
    // Gigabytes range (>= 1024*1024*1024)
    [1024 * 1024 * 1024, `1.00 GB`],
    [1024 * 1024 * 1024 * 1.5, `1.50 GB`],
    [1024 * 1024 * 1024 * 10, `10.00 GB`],
    [1024 * 1024 * 1024 * 100, `100.00 GB`],
    [1024 * 1024 * 1024 * 1000, `1000.00 GB`],
