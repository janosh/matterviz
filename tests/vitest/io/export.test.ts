...
describe(`Export functionality`, () => {
  ...
  describe(`Round-trip tests`, () => {
    it(`round-trips real structure data correctly`, () => {
      ...
      expect(lines[2]).toBe(`Cs 0.000000 0.000000 0.000000`)
      expect(lines[3]).toBe(`Cs 3.128465 3.128465 3.128465`)
      expect(lines).toHaveLength(4)

      // Export to JSON and verify all sites are present
      const json_content = structure_to_json_str(parsed_structure as AnyStructure)
