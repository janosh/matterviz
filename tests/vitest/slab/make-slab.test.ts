...
describe(`lattice basis`, () => {
  ...
  // MAX_SLAB_SITES bounds the slab, which costs nothing: this supercell reduces to a 12-site
  // oriented cell, and the 2.4 s goes into the translation search that gets it there, whose
  // cost is set by the INPUT. The probe count in the message pins the 6912 sites built here.
