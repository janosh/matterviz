...
- ⚠️ **File size limit**: Files up to 1 GiB are read into extension memory in one operation on both local and Remote SSH workspaces. Files larger than 1 GiB are rejected to prevent memory issues.
