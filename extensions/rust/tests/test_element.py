...
class TestElement:
    ...
    def test_element_name(self, symbol: str, expected_name: str) -> None:
        ...
        assert ferrox.Element(symbol).name == expected_name
    ...
    def test_atomic_mass(self, symbol: str, expected_mass: float) -> None:
        ...
        assert abs(ferrox.Element(symbol).atomic_mass - expected_mass) < 0.01
    ...
    def test_block(self, symbol: str, expected_block: str) -> None:
        """Block is correct."""
        assert ferrox.Element(symbol).block == expected_block
    ...
    def test_element_equality(self) -> None:
        ...
        fe1 = ferrox.Element("Fe")
        fe2 = ferrox.Element(26)
        assert fe1 == fe2
    ...
    def test_ionic_radii(
        ...
        radii = ferrox.Element(symbol).ionic_radii
    ...
    def test_ionic_radii_none_for_noble_gas(self) -> None:
        ...
        assert ferrox.Element("He").ionic_radii is None
    ...
    def test_shannon_radii_none_for_noble_gas(self) -> None:
        ...
        assert ferrox.Element("He").shannon_radii is None
...
class TestCompositionFunctions:
    ...
    def test_formula_hash_same_for_equivalent_formulas(self) -> None:
        ...
        hash1 = ferrox.formula_hash("Fe2O3")
        hash2 = ferrox.formula_hash("O3Fe2")  # Different order, same composition
        assert hash1 == hash2
    ...
    def test_formula_hash_different_for_different_formulas(self) -> None:
        ...
        hash_fe2o3 = ferrox.formula_hash("Fe2O3")
        hash_feo = ferrox.formula_hash("FeO")
    ...
    def test_species_hash_different_for_different_compositions(self) -> None:
        ...
        hash1 = ferrox.species_hash("Fe2O3")
        hash2 = ferrox.species_hash("FeO")
        assert hash1 != hash2
    ...
    def test_remap_elements_invalid_element_raises(self) -> None:
        ...
        with pytest.raises(ValueError, match="Unknown element"):
            ferrox.remap_elements("Fe2O3", {"Fe": "Zz"})
    ...
    def test_get_reduced_factor(self, formula: str, expected_factor: float) -> None:
        ...
        assert abs(ferrox.get_reduced_factor(formula) - expected_factor) < 1e-6
...
class TestRdfFunctions:
    ...
    def test_rdf_functions_exported(self, func_name: str) -> None:
        ...
        assert hasattr(ferrox, func_name)
